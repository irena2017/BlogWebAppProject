						...
						<tbody>
							<c:forEach var="message" items="${messageList}">
								<tr>
									...
									<td class="text-center">${message.user.name} ${message.user.surname}</td>
									<td class="text-center"><img src="${message.user.image.imageUrl}" style="max-width: 80px;"></td>
									<td class="text-center">${message.name}</td>
									<td class="text-center">${message.email}</td>
									<td class="text-center">${message.message}</td>
									<td class="text-center">${message.dateOnly}</td>
									<td class="text-center">
										<div class="btn-group">
											<c:if test="${!message.isRead}">
												<div>
													<a class="btn btn-info" href="message-read?id=${message.id}"> 
											...
											<c:if test="${message.isRead}">
												<div>
													<a class="btn btn-info" href="message-read?id=${message.id}"> 
													<span class="fa-solid fa-envelope-circle-check fa-lg"></span>
													</a>
												</div>
											</c:if>
											<br>
									...
									<div class="modal-dialog">
										<div class="modal-content">
											...
											<div class="modal-footer justify-content-between">
												<a href="${messageList}" button type="button"
