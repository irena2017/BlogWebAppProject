							...
							<div class="card">
								<div class="card-header">
									...
									<div class="card-tools">
										<a href="slide-form" class="btn btn-success"> <i
								...
								<table class="table table-bordered">
									...
									<tbody>
										<c:forEach var="slide" items="${slideList}">
											...
											<img src="${slide.image.imageUrl}" alt="..." class="img-fluid" style="max-width: 80px;"/>
										</td>
												<td class="text-center"><strong>${slide.name}</strong></td>
												<td class="text-center">${slide.buttonUrl}</td>
												<td class="text-center">${slide.buttonName}</td>
												<td class="text-center">${slide.position}</td>
												<td class="text-center">
													<div class="btn-group">
														<div>
															<a href="slide-form-update?id=${slide.id}"
																class="btn btn-info"> <i class="fas fa-edit"></i>
															</a>
														</div>

														<a href="slide-enable?id=${slide.id}" class="btn btn-info">
															<c:if test="${slide.enabled}">
																<i class="fas fa-eye"></i>
															</c:if> <c:if test="${!slide.enabled}">
