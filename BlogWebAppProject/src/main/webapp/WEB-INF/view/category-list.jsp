												...
												<tr class="text-center">
												   <td class="text-center">${category.id}</td>
													<td class="text-center"><a
														href="${pageContext.request.contextPath}/administration/update-category-order?categoryId=${category.id}&direction=up">
															<i class="fa-solid fa-sort-up" style="color: black"></i>
													</a> <br> <a
														href="${pageContext.request.contextPath}/administration/update-category-order?categoryId=${category.id}&direction=down">
															<i class="fa-solid fa-sort-down" style="color: black"></i>
													</a> <br> ${category.position}</td>
													<td class="text-center"><strong>${category.name}</strong></td>
													<td class="text-center">${category.description}</td>
													<td class="text-center"><img
														src="${category.image.imageUrl}" alt="..."
