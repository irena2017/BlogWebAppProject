...
<meta name="description" content="blog, tags, travel, business, health, lifestyle, sports, fitness, fashion & trends, music, food, tips">
			...
			<main class="posts-listing col-lg-8">
				<div class="container">
					<div class="row">
						...
						<c:forEach var="blog" items="${blogsByTag}">
							<c:if test="${not nameShown}">
								<h2 class="field-title">${blog.tags[0].name}</h2>
