...
<meta name="description" content="blog, category, business, sports, food, travel, tips, tricks, music, dance, hits, fashion, health, lifestyle">
			...
			<main class="posts-listing col-lg-8">
				<div class="container">
					<div class="row">
						...
						<c:forEach var="blog" items="${blogsByCategory}">
							<c:if test="${not nameShown}">
								<h2 class="field-title">${blog.category.name}</h2>
