...
<meta name="description" content="contact us, form, ask, write, get in touch">
...
<body>
		...
		<nav class="navbar navbar-expand-lg">
			...
			<div class="container">
				...
				<div
					...
					<!-- Navbar Brand -->
					<a href="index-page" class="navbar-brand">Bootstrap Blog</a>
					<!-- Toggle Button-->
	...
	<div class="container">
		<div class="row">
			<main class="col-lg-8">
				<div class="container">
					<form:form method="post" action="message-save"
						class="commenting-form" modelAttribute="message" role="form">
						<form:hidden path="id" />
						<div class="row">
							...
							<div class="form-group col-md-12">
								<label>Message</label>
								<form:textarea placeholder="Type your message"
									class="form-control" rows="20" path="message" />
							</div>
							<div class="form-group col-md-12">
					...
					<div class="blog-posts">
						<c:forEach var="blog" items="${mostPopularBlogs}">
							<div class="item d-flex align-items-center">
								...
								<div class="title">
		<a href="blog-post?blogName=${blog.seoName}"><strong>${blog.name}</strong></a>
