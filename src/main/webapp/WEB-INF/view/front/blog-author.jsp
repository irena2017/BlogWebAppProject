...
<meta name="description" content="blog, authors,business, sports, food, travel, tips, tricks, music, dance, hits, latest, health, lifestyle">
		...
		<nav class="navbar navbar-expand-lg">
			...
			<div class="container">
				...
				<div
					...
					<!-- Navbar Brand -->
					<a href="index-page" class="navbar-brand">Blogs</a>
					<!-- Toggle Button-->
	...
	<div class="container">
		<div class="row">
			...
			<main class="posts-listing col-lg-8">
				<div class="container">
					<div class="row">
						<c:set var="nameShown" value="false" />
						<c:forEach var="blog" items="${blogsByAuthor}">
							<c:if test="${not nameShown}">
								<div class="mb-3 author d-flex align-items-center flex-wrap">
									<div class="avatar">
									...
									<div class="title">
										<h2 style="white-space: nowrap;">Posts by author
											${blog.user.name} ${blog.user.surname}</h2>
									</div>
								</div>
								<c:set var="nameShown" value="true" />
							</c:if>
