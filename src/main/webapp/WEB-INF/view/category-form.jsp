            ...
            <div class="card card-primary">
              ...
              <form:hidden path="id"/>
                <div class="card-body">
                  ...
                  <div class="form-group">
				  <label for="fileImage">Image</label> <input type="file"
				  name="fileImage" id="fileImage"
				  accept="image/png, image/jpeg, image/jpg"/>
				  </div>
				  <div class="form-group">
                  <label>Position</label>
                    <form:input path="position" type="number"  class="form-control" placeholder="Enter position number" min="1" required="true" />
