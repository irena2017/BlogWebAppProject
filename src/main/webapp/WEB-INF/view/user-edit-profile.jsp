...
<body class="hold-transition sidebar-mini">
	<div class="wrapper">
		...
		<aside class="main-sidebar sidebar-dark-primary elevation-4">
			<!-- Brand Logo -->
			<a href="https://cubes.edu.rs/" class="brand-link"> 
							...
							<div class="card">
								<div class="card-header">
									...
									<div class="card-tools">
										<a href="user-change-password" class="btn btn-outline-warning">
								...
								<!-- /.card-header -->
								<!-- form start -->
								<form:form role="form" action="user-edit-profile-action" method="post"
									...
									<div class="card-body">
										<div class="row">
											<div class="col-md-6">
												...
												<div class="form-group">
													<label for="fileImage">Photo</label> <input type="file"
														name="fileImage" id="fileImage"
														accept="image/png, image/jpeg, image/jpg" />
														<br><br>
														<img src="${user.image.imageUrl}" alt="Current Photo" width="100"
														height="100" />
														</div>
												<div class="form-group">
													<label>Phone</label>
