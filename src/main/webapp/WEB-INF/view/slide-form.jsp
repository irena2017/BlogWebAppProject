					...
					<div class="row mb-2">
						...
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								...
								<li class="breadcrumb-item"><a href="slide-list">Slides</a></li>
								...
								<form:form action="slide-save" modelAttribute="slide" role="form"
								 method="post" enctype="multipart/form-data">
										...
										<div class="row">
											<div class="col-md-6">
												...
												<div class="form-group">
													<label>Website</label>
													<form:input type="text" class="form-control"
														placeholder="Enter button url" path="buttonUrl" />
													<form:errors path="buttonUrl" cssClass="text-danger" />
												</div>
												<div class="form-group">
													<label>Button name</label>
													<form:input type="text" class="form-control"
														placeholder="Enter button name" path="buttonName" />
													<form:errors path="buttonName" cssClass="text-danger" />
												</div>
												<div class="form-group">
													<label for="role">Status</label>
													<form:select path="enabled" itemValue="enabled" class="form-control">
													...
													<form:input type="number" class="form-control"
														id="position" placeholder="Enter slide position"
														path="position" min="1" required="true" />
									...
									<div class="card-footer">
										...
										<a href="slide-list" class="btn btn-outline-secondary">Cancel</a>
									</div>
								</form:form>
